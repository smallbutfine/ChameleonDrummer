...
uses
  Classes, SysUtils, ArgParse, Generics.Collections,
  core_models_pattern, core_models_song,
  generation_engines_drum_generator, export_midi_midi_engine,
  plugins_registry_plugin_registry, core_models_kit;
